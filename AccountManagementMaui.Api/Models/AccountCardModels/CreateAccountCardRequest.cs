...
public class CreateAccountCardRequest : IValidatableObject
{
    ...
    [Range(1, int.MaxValue, ErrorMessage = "Bir hesap kart tipi seçiniz.")]
    public int AccountCardTypeId { get; set; }


    [Display(Name = "Hesap Kart Türü")]
    [Range(1, int.MaxValue, ErrorMessage = "Bir hesap kart türü seçiniz.")]
    ...
    [Display(Name = "Hesap Kart Alt Grubu")]
    ...
    [RegularExpression(@"^\d{10}$", ErrorMessage = "Vergi numarası 10 rakamdan oluşmalıdır.")]
    public string? TaxNumber { get; set; }


    [Display(Name = "T.C. Kimlik Numarası")]
    [RegularExpression(@"^\d{11}$", ErrorMessage = "T.C. kimlik numarası 11 rakamdan oluşmalıdır.")]
